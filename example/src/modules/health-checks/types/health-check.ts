...
export const HealthCheck = builder
	...
	.implement({
		...
		fields: (t) => ({
			redis: t.field({
				type: builder
					.objectRef<HealthCheck['redis']>('RedisHealthCheck')
					.implement({
						fields: (t) => ({
							subscribe: t.boolean({
								description:
			...
			database: t.field({
				type: builder
					.objectRef<HealthCheck['database']>('DatabaseHealthCheck')
					.implement({
						fields: (t) => ({
							prisma: t.boolean({
			...
			ldap: t.field({
				type: builder
					.objectRef<HealthCheck['ldap']>('LdapHealthCheck')
					.implement({
						fields: (t) => ({
							school: t.boolean({
								description:
			...
			mail: t.field({
				type: builder
					.objectRef<HealthCheck['mail']>('MailHealthCheck')
					.implement({
						fields: (t) => ({
							smtp: t.boolean({
