		...
		validate: [
			[
				({ input: { visibility, group } }) =>
					group ? Boolean(visibility) : true,
				{
					message:
						'La visibilité est requise pour les formulaires associés à un groupe.',
					path: ['visibility'],
				},
			],
			[
				...
				{
					message:
						'Les formulaires non associés à un groupe doivent être non répertoriés.',
					path: ['visibility'],
				},
			],
		],
