...
export const QuestionKindType = builder.enumType(QuestionKind, {
	...
	values: {
		...
		Number: {
			description: 'La réponse est un nombre, potentiellement à virgule.',
		},
		Scale: {
			description: 'La réponse est un nombre entier entre deux bornes',
		},
		SelectMultiple: {
			description:
		...
		SelectOne: {
			description: 'La réponse est une des options parmi une liste.',
		},
