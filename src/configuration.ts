...
export const configSchema = z
  .object({
    ...
    schema: z
      .union([
        z.object({ static: z.string() }).describe("Path to a schema file"),
        z
          .object({
            introspection: z.object({
              ...
              headers: z
                .record(z.string())
                .optional()
                .describe("Headers to send with the introspection query"),
            }),
          })
        ...
        relay: z
          .object({
            ...
            nodes: z
              .string()
              .default("edges.node")
              .describe("Dotted path to the node from a connection object"),
            edges: z
              .string()
              .default("edges")
              .describe(
    ...
    modules: z
      .object({
        ...
        fallback: z.string().optional().describe("Fallback module name"),
        filesystem: z
          .array(z.string())
          .optional()
          .describe(
