		...
		[
			{
				json: 'description',
				js: 'description',
				typ: u(undefined, u(r('DescriptionClass'), '')),
			},
			...
			{ json: 'items', js: 'items', typ: u(undefined, a(r('Item'))) },
			{
				json: 'title',
				js: 'title',
				typ: u(undefined, u(r('TitleClass'), '')),
			},
		],
		false,
	),
	DescriptionClass: o([{ json: 'in', js: 'in', typ: '' }], false),
	Item: o(
		[
			...
			{ json: 'in', js: 'in', typ: u(undefined, '') },
			{
				json: 'matchers',
				js: 'matchers',
				typ: u(undefined, a(r('SourceCodeMatcher'))),
			},
		],
		false,
	),
		...
		[
			{
				json: 'ast-grep',
				js: 'ast-grep',
				typ: u(undefined, u(r('Rule'), '')),
			},
			{
				json: 'constraints',
				js: 'constraints',
				typ: u(undefined, u(m(r('Rule')), null)),
			},
	...
	Relation: o(
		[
			...
			{ json: 'not', js: 'not', typ: u(undefined, r('Rule')) },
			{
				json: 'nthChild',
				js: 'nthChild',
				typ: u(undefined, u(0, r('SerializableNthChildObject'), '')),
			},
			{
				json: 'pattern',
				js: 'pattern',
				typ: u(undefined, u(r('PatternStyleObject'), '')),
			},
			{
				json: 'precedes',
				js: 'precedes',
			...
			{ json: 'regex', js: 'regex', typ: u(undefined, '') },
			{
				json: 'stopBy',
				js: 'stopBy',
				typ: u(undefined, u(r('Rule'), r('SerializableStopByEnum'))),
			},
		],
		'any',
	),
	...
	PatternStyleObject: o(
		[
			...
			},
			{
				json: 'strictness',
				js: 'strictness',
				typ: u(undefined, u(r('Strictness'), null)),
			},
		],
		'any',
	),
	TitleClass: o([{ json: 'in', js: 'in', typ: '' }], false),
	SerializableStopByEnum: ['end', 'neighbor'],
	Strictness: ['ast', 'cst', 'relaxed', 'signature', 'smart'],
};
